...
The plot below compares how the number of confirmed cases of China compares with the rest of the world. While China seems to have stabilized around the first half of March (before the pandemic was declared), the curve of the other countries (as a whole) is slowing down just after April.
